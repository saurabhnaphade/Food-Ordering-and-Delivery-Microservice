...
public class Orders {
	...
	public Orders(int order_id, String menu_name, String restaurant_name, String cust_address, int quantity,
	...
	public String toString() {
		return "Orders [order_id=" + order_id + ", menu_name=" + menu_name + ", restaurant_name=" + restaurant_name
